...
/***/ function(module, exports, __webpack_require__) {
	...
	var _Counter = function (p) {
	    return React.createElement("div", null, 
	        React.createElement("p", null, 
	            React.createElement("label", null, "Counter: "), 
	            React.createElement("b", null, p.counter)), 
	        React.createElement("button", {onClick: function (e) { return p.incr(); }}, "INCREMENT"), 
	        React.createElement("span", {style: { padding: "0 5px" }}), 
	        React.createElement("button", {onClick: function (e) { return p.decr(); }}, "DECREMENT"));
	};
	// const creator:MapDispatchToPropsFunction<DispatchProps,{}> = (d:Dispatch<any>) => ({
	//     incr: () => { return d({type:"INCR"})},
	//     decr: () => d({type:"DECR"})
	// });
	var creator = function (d) {
	    return redux_1.bindActionCreators({
	        incr: function () { return ({ type: "INCR" }); },
	        decr: function () { return ({ type: "DECR" }); }
	    }, d);
	};
	var Counter = react_Redux_1.connect(function (x) { return x; }, creator)(_Counter);
